...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 md:p-12 overflow-hidden relative">
      ...
      <div 
        className="absolute top-[-10%] left-[-10%] w-96 h-96 rounded-full blur-[120px] -z-10 opacity-30 bg-sage-green" 
      />
      ...
      <div className="z-10 max-w-6xl w-full flex flex-col items-center text-center gap-8 mx-auto mt-12">
        ...
        <motion.div
          ...
          className="inline-flex items-center justify-center gap-2 px-5 py-2 rounded-full border border-sage-green/20 bg-sage-green/10 text-sage-green text-sm font-semibold tracking-wide mx-auto"
        >
          <Sprout size={18} />
        ...
        >
          ...
          <span className="text-sage-green">Connecting Markets.</span>
        </motion.h1>
        ...
        >
          <button className="px-8 py-4 text-white rounded-xl font-semibold hover:opacity-90 transition-opacity w-full sm:w-48 shadow-lg shadow-black/10 flex items-center justify-center bg-sage-green">
            Join as Farmer
          </button>
          <button className="px-8 py-4 text-white rounded-xl font-semibold hover:opacity-90 transition-opacity w-full sm:w-48 shadow-lg shadow-black/10 flex items-center justify-center bg-pitch-black">
            Join as Trader
          </button>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={i} className="flex flex-col items-center justify-center p-8 bg-white rounded-2xl border border-[#F0EBE1] shadow-sm hover:shadow-md transition-all text-center h-full">
